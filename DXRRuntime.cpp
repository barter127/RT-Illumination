...
void DXRRuntime::Render()
{
	...
	m_ui->GPUDebugPanel(&m_app->m_shadowSampleCount, &m_app->m_materialAlbedo, &m_app->m_materialRoughness, &m_app->m_materialMetalness, &m_app->m_usePointSampling, &m_app->m_glassColour.x);
